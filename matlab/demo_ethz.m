...
name = 'ethz';
[pos test] = getPositiveData('../dataset/ETHZ/small/positive','.jpg','.txt',0.7);
neg        = getNegativeData('../dataset/ETHZ/small/negative', '.jpg');
pos        = pointtobox(pos,pa);

% --------------------
% training
model = trainmodel(name,pos,neg,K,pa,sbin);
save('ethz.mat', '-mat-binary', 'model', 'pa', 'sbin', 'name');
